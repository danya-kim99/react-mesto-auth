  ...
  return (
    <div className="authorization">
        ...
        <form className="authorization__form" onSubmit={onSubmit}>
            <input className="authorization__input authorization__input_type_email" placeholder="Email" id="email" name="email" type="email" value={formValue.email} onChange={onChange}></input>
            <input className="authorization__input authorization__input_type_password" placeholder="Пароль" id="password" name="password" type="password" value={formValue.password} onChange={onChange}></input>
